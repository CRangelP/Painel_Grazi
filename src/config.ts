...
const ACTIVITIES_MUNICIPAL: ActivityRule[] = [
  ...
  {
    label: "ANALISAR RPV / PRECATÓRIO",
    complexity: "media",
    pattern: /RPV|PRECATORIO|PEQUENO VALOR/,
  },
  ...
  {
    label: "PAGAMENTO / ALVARÁ / CONTRACHEQUE",
    complexity: "baixa",
    pattern: /PAGAMENTO|ALVARA|CONTRACHEQUE|GUIA/,
  },
  { label: "CONTADORIA", complexity: "baixa", pattern: /CONTADORIA/ },
  {
    label: "DOCUMENTAÇÃO / PENDÊNCIA",
    complexity: "baixa",
    pattern:
      /PROCURACAO|COMPROVANTE|DOCUMENTA|PENDENCIA COMERCIAL|SENHA|SAC|DADOS BANCARIOS|DESARQUIV/,
  },
  { label: "DECURSO DE PRAZO", complexity: "baixa", pattern: /DECURSO/ },
  {
    label: "ANALISAR PROCESSO PARADO (+40 DIAS)",
    complexity: "baixa",
    pattern: /PROCESSO PARADO|40 DIAS/,
  },
...
const ACTIVITIES_ESTADUAL: ActivityRule[] = [
  ...
  {
    label: "VERIFICAR POSS. DE RECURSO",
    complexity: "alta",
    pattern: /RECURSO|EMBARGOS|AGRAVO|REPROTOCOLO/,
  },
  { label: "PEDIR SEQUESTRO", complexity: "media", pattern: /SEQUESTRO/ },
  ...
  { label: "ANALISAR TRÂNSITO EM JULGADO", complexity: "baixa", pattern: /TRANSIT/ },
  {
    label: "PAGAMENTO / ALVARÁ / CONTRACHEQUE",
    complexity: "baixa",
    pattern: /PAGAMENTO|ALVARA|CONTRACHEQUE/,
  },
  { label: "CONTADORIA", complexity: "baixa", pattern: /CONTADORIA/ },
  {
    label: "DOCUMENTAÇÃO / PENDÊNCIA",
    complexity: "baixa",
    pattern:
      /PROCURACAO|PROCURA|COMPROVANTE|DOCUMENTA|DOCUMENTO|ENDERECO|CESSAO|CUC|DESARQUIV|BLOQUEIO|REGULARIZAR/,
  },
  ...
  { label: "VERIFICAR ANDAMENTO", complexity: "baixa", pattern: /ANDAMENTO/ },
  {
    label: "ANÁLISE EM GERAL",
    complexity: "baixa",
    pattern: /ANALISAD|ANALISE DE DIREITO|ANALISAR PROCESSO|HOUVE PAGAMENTO|ANALISAR PAGAMENTO/,
  },
];
...
export const RATE_LIMIT_MS = 1000; // ~60 req/min, under the 100/min cap
